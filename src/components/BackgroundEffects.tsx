        ...
        <div className="fixed inset-0 z-[-1] overflow-hidden bg-[#020410] pointer-events-none">
            ...
            {!isMobile && (
                <>
                    ...
                    <div className="absolute -top-[5%] left-[5%] w-[50vw] h-[150vh] bg-gradient-to-b from-blue-400/25 via-blue-600/10 to-transparent blur-[60px] origin-top mix-blend-screen spotlight-left"
                        style={{ clipPath: "polygon(20% 0%, 80% 0%, 100% 100%, 0% 100%)" }}
                    />
                    <div className="absolute -top-[5%] right-[5%] w-[50vw] h-[150vh] bg-gradient-to-b from-purple-400/25 via-purple-600/10 to-transparent blur-[60px] origin-top mix-blend-screen spotlight-right"
                        style={{ clipPath: "polygon(20% 0%, 80% 0%, 100% 100%, 0% 100%)" }}
                    />

                    {/* Dynamic Lasers */}
                    <div className="absolute -top-[2%] left-[30%] w-[2px] h-[150vh] bg-cyan-400/80 blur-[2px] origin-top mix-blend-screen laser-left" />
                    <div className="absolute -top-[2%] left-[35%] w-[2px] h-[150vh] bg-blue-400/60 blur-[2px] origin-top mix-blend-screen laser-left" style={{ animationDelay: '0.5s', animationDuration: '3s' }} />

                    <div className="absolute -top-[2%] right-[30%] w-[2px] h-[150vh] bg-fuchsia-400/80 blur-[2px] origin-top mix-blend-screen laser-right" />
                    <div className="absolute -top-[2%] right-[35%] w-[2px] h-[150vh] bg-purple-400/60 blur-[2px] origin-top mix-blend-screen laser-right" style={{ animationDelay: '0.8s', animationDuration: '3.5s' }} />
            ...
            {/* High Intensity Light Source points (The Rig) - reduced on mobile */}
