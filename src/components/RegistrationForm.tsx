            ...
            >
                ...
                <div className="relative z-10">
                    <div className="text-center mb-8 md:mb-12">
                        ...
                        >
                            <span className="hover:text-[#ff3d00] transition-all duration-300 hover:drop-shadow-[0_0_20px_rgba(255,61,0,0.8)]">SANGRILA 2K26</span> - <span className="text-primary italic hover:text-[#00e5ff] transition-all duration-300 hover:drop-shadow-[0_0_20px_rgba(0,229,255,0.8)]">REGISTRATION</span>
                            <div className="absolute -bottom-2 left-0 w-0 h-1 bg-gradient-to-r from-[#ff3d00] via-[#00e5ff] to-[#8b5cf6] group-hover/reg:w-full transition-all duration-700 rounded-full opacity-60 shadow-[0_0_10px_rgba(255,61,0,0.4)]" />
                        </motion.h2>
