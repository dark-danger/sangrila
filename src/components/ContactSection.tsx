        ...
        <footer id="contact" className="py-24 px-6 relative z-10 glass mx-4 rounded-[3rem] mt-24 border-white/5">
                ...
                >
                    <div className="space-y-6">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-[10px] font-black tracking-[0.4em] text-primary uppercase glow-primary hover:text-[#00e5ff] transition-all duration-300 hover:drop-shadow-[0_0_15px_rgba(0,229,255,0.8)] cursor-default">Sangrila 2k26</span>
                        </div>
                        <motion.h2
            ...
            <div className="max-w-7xl mx-auto mt-24 pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="flex items-center gap-4 group/footer">
                    <span className="text-xl font-black text-white tracking-tighter uppercase leading-none group-hover/footer:text-[#ff3d00] transition-all duration-300 group-hover/footer:drop-shadow-[0_4px_12px_rgba(255,61,0,0.6)] group-hover/footer:scale-[1.03] cursor-default">SANGRILA <span className="text-primary italic group-hover/footer:text-[#00e5ff] transition-all duration-300">2K26</span></span>
                </div>
