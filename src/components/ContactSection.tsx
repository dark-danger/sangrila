                ...
                >
                    <div className="space-y-6">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-[10px] font-black tracking-[0.4em] text-primary uppercase glow-primary hover:text-white transition-all duration-300 hover:drop-shadow-[0_0_10px_rgba(255,255,255,0.8),0_0_20px_rgba(241,90,36,0.4)] cursor-default">Sangrila 2k26</span>
                        </div>
                        <motion.h2
