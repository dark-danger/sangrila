        ...
        <footer id="contact" className="py-24 px-6 relative z-10 glass mx-4 rounded-[3rem] mt-24 border-white/5">
                ...
                >
                    <div className="space-y-6">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-[10px] font-black tracking-[0.4em] text-primary uppercase glow-primary">Sangrila 2k26</span>
                        </div>
                        <motion.h2
            ...
            <div className="max-w-7xl mx-auto mt-24 pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="flex items-center gap-4">
                    <span className="text-xl font-black text-white tracking-tighter uppercase leading-none">SANGRILA <span className="text-primary italic">2K26</span></span>
                </div>
