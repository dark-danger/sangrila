        ...
        <footer id="contact" className="py-24 px-6 relative z-10 glass mx-4 rounded-[3rem] mt-24 border-white/5">
                ...
                >
                    <div className="space-y-6">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-[10px] font-black tracking-[0.4em] text-primary uppercase glow-primary hover:text-white transition-colors duration-300 cursor-default">Sangrila 2k26</span>
                        </div>
                        <motion.h2
            ...
            <div className="max-w-7xl mx-auto mt-24 pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="flex items-center gap-4 group">
                    <span className="text-xl font-black text-white tracking-tighter uppercase leading-none group-hover:text-primary transition-all duration-300 group-hover:drop-shadow-[0_0_10px_rgba(241,90,36,0.5)] cursor-default">SANGRILA <span className="text-primary italic group-hover:text-white transition-all duration-300">2K26</span></span>
                </div>
