                ...
                >
                    {teamMembers.map((member, _index) => (
                        <motion.div
                            ...
                            className="group relative bg-[#11121d] rounded-[2rem] border border-white/10 hover:border-primary/50 transition-all duration-500 shadow-xl hover:shadow-[0_0_30px_rgba(139,92,246,0.2)] overflow-hidden h-[400px] flex flex-col"
                        >
                            {/* Shine Effect */}
                            ...
                            <div className="relative w-full h-full overflow-hidden">
                                {/* Soft Gradient Overlay - Always present but subtle */}
                                <div className="absolute inset-0 bg-gradient-to-t from-[#05060f]/90 via-transparent to-transparent z-10 opacity-60 group-hover:opacity-40 transition-opacity duration-500" />
                                ...
                                {/* Social Links - Top Right Reveal */}
                                <div className="absolute top-4 right-4 z-30 flex flex-col gap-3 translate-x-10 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-500 delay-100">
                                    {member.instagram && (
                                        <a href={member.instagram} target="_blank" rel="noopener noreferrer" className="p-3 bg-white/10 hover:bg-primary backdrop-blur-md rounded-full text-white transition-colors duration-300 transform hover:scale-110">
                                            <Instagram size={20} />
                                        </a>
                                    )}
                                    {member.linkedin && (
                                        <a href={member.linkedin} target="_blank" rel="noopener noreferrer" className="p-3 bg-white/10 hover:bg-[#0077b5] backdrop-blur-md rounded-full text-white transition-colors duration-300 transform hover:scale-110 delay-75">
                                            <Linkedin size={20} />
                                        </a>
                                    )}
                                </div>
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-6 z-20 translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                                <div className="space-y-1">
                                    ...
                                    <p className="text-primary/90 font-semibold text-sm uppercase tracking-wider mb-2">
                                        {member.role}
                                    </p>
                                </div>
